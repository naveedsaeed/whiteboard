...
(function(e) {
    ...
    }), Te ? module.exports = he : "function" == typeof define && define.amd ? (define("moment.3150e071", function(e, t, n) {
...
!function(e, n) {
    ...
    t.init = !0, "undefined" != typeof module && module.exports ? module.exports = t : "function" == typeof define && define.amd ? define("smoke.0ec1ddb1", [], function() {
        return t;
    }) : this.smoke = t;
}(window, document);
...
var SpacedeckBoardArtifacts = {
    ...
    artifact_oembed_html: function(t) {
        ...
        return "soundcloud" == r ? '<iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=' + t.meta.link_uri.replace(":", "%3A") + '"></iframe>' : "spacedeck.6d6af1d9" == r ? "" : "Don't know how to embed " + t.mime + ".";
    },
...
function setup_directives() {
    if (Vue.directive("clipboard.83b786b5", {
        bind: function() {
